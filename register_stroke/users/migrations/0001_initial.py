    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='«Нельзя использовать пробел и символы, кроме . @ + - _».', regex='^[\\w.@+-]+$')], verbose_name='имя пользователя в системе')),
